...
$qry_validate = mysqli_query($con,"select * from `district` where `name`='$name' ") or die(mysqli_error($con));
if(mysqli_num_rows($qry_validate)>0)
{
$msg ='<center><span style="color:#ff0000;">District already exists<span></center>';
}
else
{

$insert = mysqli_query($con,"insert into `district`(`name`,`keywords`,`meta_title`,`meta_key`,`meta_desc`,`desc`,`order`,`status`,`c_date`)values('$name','$keywords','$meta_title','$meta_key','$meta_desc','$desc','$order','$status','$c_date')") or die(mysqli_error($con));

$msg ='<center><span style="color:#ff0000;">District insert successfully<span></center>';
}
...
$update = mysqli_query($con,"update `district` set `name`='$name',`keywords`='$keywords',`meta_title`='$meta_title',`meta_key`='$meta_key',`meta_desc`='$meta_desc',`desc`='$desc',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));

//$msg ='<center><span style="color:#ff0000;">Admin Updated Successfully<span></center>';
?>
<script type="text/javascript">
//alert('Delete Successfully');
window.location='district_list.php?msg=updated';
</script>
<?php
}
...
{
$select  = mysqli_query($con,"select * from `district` where `id`='".$_REQUEST['e_id']."' ")or die(mysqli_error($con));
...
<?php include('top.php'); ?>
		...
		<h2>Create District <span style="float: right;"><a href="district_list.php">District List</a></span></h2>
		<br />
					...
					<div class="panel-body">
					    ...
					    ?>
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">District Name <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="name" placeholder="District Name" required="required" value="<?php echo $select1['name']; ?>">
								</div>
							</div>
