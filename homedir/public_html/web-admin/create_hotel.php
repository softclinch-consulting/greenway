...
{
$msg ='<center><span style="color:#ff0000;">Hotel already exists<span></center>';
}
else
{

$insert = mysqli_query($con,"insert into `listing`(`v_id`,`name`,`meta_title`,`meta_key`,`meta_desc`,`cat_id`,`sub_cat_id`,`tag`,`desc`,`c_id`,`s_id`,`l_id`,`email`,`c_code`,`mobile`,`c_code1`,`land_line_no`,`website`,`fax_no`,`address`,`facebook_url`,`linkedin_url`,`twitter_url`,`instagram_url`,`pinterest_url`,`youtube_url`,`video_link`,`type`,`order`,`status`,`c_date`,`map_link`)values('$v_id','$name','$meta_title','$meta_key','$meta_desc','$cat_id','$sub_cat_id','$tag','$desc','$c_id','$s_id','$l_id','$email','$c_code','$mobile','$c_code1','$land_line_no','$website','$fax_no','$address','$facebook_url','$linkedin_url','$twitter_url','$instagram_url','$pinterest_url','$youtube_url','$video_link','$type','$order','$status','$c_date','$map_link')") or die(mysqli_error($con));
...
$destination1 ='../banner/'.$imagename1;
...
$msg ='<center><span style="color:#ff0000;">Hotel insert successfully<span></center>';
}
...
$update = mysqli_query($con,"update `listing` set `v_id`='$v_id',`name`='$name',`meta_title`='$meta_title',`meta_key`='$meta_key',`meta_desc`='$meta_desc',`cat_id`='$cat_id',`sub_cat_id`='$sub_cat_id',`tag`='$tag',`desc`='$desc',`c_id`='$c_id',`s_id`='$s_id',`l_id`='$l_id',`email`='$email',`c_code`='$c_code',`mobile`='$mobile',`c_code`='$c_code',`land_line_no`='$land_line_no',`website`='$website',`fax_no`='$fax_no',`facebook_url`='$facebook_url',`linkedin_url`='$linkedin_url',`twitter_url`='$twitter_url',`instagram_url`='$instagram_url',`pinterest_url`='$pinterest_url',`youtube_url`='$youtube_url',`video_link`='$video_link',`address`='$address',`price_range`='$price_range',`price_from`='$price_from',`price_to`='$price_to',`type`='$type',`order`='$order',`status`='$status',`map_link`='$map_link' where `id`='$_REQUEST[edit_id]' ")or die(mysqli_error($con));
...
window.location='hotel_list.php?msg=updated';
</script>
<?php
}
...
<?php include('top.php'); ?>
		...
		<h2>Create Hotel <span style="float: right;"><a href="hotel_list.php">Hotel List</a></span></h2>
		<br />
		...
		<form role="form" class="form-horizontal form-groups-bordered" action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Vendor<span style="color:#ee4749">*</span></label>
                        ...
                        <?php
    $user_vendor  = mysqli_query($con,"select * from `user_vendor` where `type`='1' order by `name` asc ")or die(mysqli_error($con));
					    ...
					    ?>
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Hotel Name<span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="name" placeholder="Hotel Name" required="required" value="<?php echo $select1['name']; ?>">
								</div>
							</div>
...
xmlhttp.send();
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" name="cat_id" required="required" onchange="category(this.value,'category_listing');" >
...
<?php } ?>
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Tagline <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="tag" placeholder="Tagline" required="required" value="<?php echo $select1[tag]; ?>">
								</div>
							</div>
...
<div class="panel-heading">
					...
					<div class="form-group">
							...
							<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Listing Photo <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="file" class="form-control" id="field-1" name="photo" placeholder="Listing Photo" value="<?php echo $select1[photo]; ?>">
								</div>
							</div>


							<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Listing Banner <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="file" class="form-control" id="field-1" name="banner" placeholder="Listing Banner" value="<?php echo $select1[banner]; ?>">
								</div>
							</div>
					...
					<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Monday <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Opening Time" required="required" value="<?php echo $select1[order]; ?>">
								</div>

								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Closing Time" required="required" value="<?php echo $select1[order]; ?>">
								</div>
							</div>


							<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Tuesday <span style="color:#ee4749">*</span></label>
							...
							<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Wednesday <span style="color:#ee4749">*</span></label>
							...
							<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Thursday <span style="color:#ee4749">*</span></label>
							...
							<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Friday <span style="color:#ee4749">*</span></label>
							...
							<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Saturday <span style="color:#ee4749">*</span></label>
							...
							<div class="form-group">
							<label for="field-1" class="col-sm-2 control-label">Sunday <span style="color:#ee4749">*</span></label>
					...
					<div class="form-group">
						...
						<option value="$" <?php if($select1[status]=='$'){?> selected="selected" <?php } ?> >$</option>
						<option value="$$" <?php if($select1[status]=='$$'){?> selected="selected" <?php } ?> >$$</option>
						<option value="$$$" <?php if($select1[status]=='$$$'){?> selected="selected" <?php } ?> >$$$</option>
						<option value="$$$$" <?php if($select1[status]=='$$$$'){?> selected="selected" <?php } ?> >$$$$</option>
						<option value="$$$$$" <?php if($select1[status]=='$$$$$'){?> selected="selected" <?php } ?> >$$$$$</option>
