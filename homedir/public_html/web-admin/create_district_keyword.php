...
/*$qry_validate = mysqli_query($con,"select * from `district_keyword` where `keywords`='$name' ") or die(mysqli_error($con));
if(mysqli_num_rows($qry_validate)>0)
{
$msg ='<center><span style="color:#ff0000;">District Keyword already exists<span></center>';
}
else
{*/

$insert = mysqli_query($con,"insert into `district_keyword`(`dt_id`,`name`,`keywords`,`meta_title`,`meta_key`,`meta_desc`,`desc`,`seo_url`,`order`,`status`,`c_date`)values('$dt_id','$name','$keywords','$meta_title','$meta_key','$meta_desc','$desc','$seo_url','$order','$status','$c_date')") or die(mysqli_error($con));

$msg ='<center><span style="color:#ff0000;">District Keyword insert successfully<span></center>';
/*}*/
...
$update = mysqli_query($con,"update `district_keyword` set `dt_id`='$dt_id',`name`='$name',`keywords`='$keywords',`meta_title`='$meta_title',`meta_key`='$meta_key',`meta_desc`='$meta_desc',`desc`='$desc',`seo_url`='$seo_url',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));

//$msg ='<center><span style="color:#ff0000;">Admin Updated Successfully<span></center>';
?>
<script type="text/javascript">
//alert('Delete Successfully');
window.location='district_keyword_list.php?msg=updated';
</script>
<?php
}
...
{
$select  = mysqli_query($con,"select * from `district_keyword` where `id`='".$_REQUEST['e_id']."' ")or die(mysqli_error($con));
					...
					<ol class="breadcrumb bc-3" >
						...
						<a href="dashboard.php"><i class="fa-home"></i>Home</a>
							...
							<li>
									...
									<a href="#">District Keyword</a>
							</li>
						<li class="active">
		
									<strong>Create District Keyword</strong>
							</li>
							</ol>
					
		<h2>Create District Keyword <span style="float: right;"><a href="district_keyword_list.php">District Keyword List</a></span></h2>
		<br />
...
xmlhttp.send();
					...
					<div class="panel-body">
						...
						<?php /*    <div class="form-group">
								...
								<div class="col-sm-5">
								<select class="form-control" name="s_id" required="required">
					    ...
					    ?>
							 ...
							 <div class="form-group">
								<label class="col-sm-3 control-label">District <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
								<select class="form-control" name="dt_id" required="required">
										
						<option value="">Select</option>
                        <?php
                        $district  = mysqli_query($con,"select * from `district` order by `name` asc ")or die(mysqli_error($con));
