...
$qry_validate = mysqli_query($con,"select * from `offers` where `name`='$name' ") or die(mysqli_error($con));
...
$insert = mysqli_query($con,"insert into `offers`(`c_id`,`s_id`,`name`,`price`,`desc`,`order`,`status`,`c_date`)values('$c_id','$s_id','$name','$price','$desc','$order','$status','$c_date')") or die(mysqli_error($con));
...
$destination1 ='../offer/'.$imagename1;
	        
move_uploaded_file($source_image1,$destination1);

mysqli_query($con,"update `offers` set `image`='$imagename1' where `id`='$last'");

}


$msg ='<center><span style="color:#ff0000;">offers insert successfully<span></center>';
}
...
$update = mysqli_query($con,"update `offers` set `c_id`='$c_id',`s_id`='$s_id',`name`='$name',`price`='$price',`desc`='$desc',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));
...
mysqli_query($con,"update `offers` set `image`='$imagename1' where `id`='".$_REQUEST['edit_id']."'");
...
window.location='offer_list.php?msg=updated';
</script>
<?php
}
...
<?php include('top.php'); ?>
		...
		<h2>Create Offers <span style="float: right;"><a href="offer_list.php">Offers List</a></span></h2>
		<br />
					    ...
					    ?>
							 ...
							 <div class="form-group">
								...
								<div class="col-sm-5">
								   ...
								   <?php } else{ ?>
									<select class="form-control" name="s_id" id="subcategory_result">
...
<?php } ?>
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Offers Name <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="name" placeholder="Offers Name" required="required" value="<?php echo $select1['name']; ?>">
								</div>
							</div>
							...
							<!--<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Offers Price <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="number" class="form-control" id="field-1" name="price" placeholder="Offers Name" required="required" value="<?php echo $select1['price']; ?>" min="0">
								</div>
							</div>


							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Offers Description <span style="color:#ee4749">*</span></label>
								

								<div class="col-sm-9">				
	<textarea name="desc" class="form-control ckeditor" placeholder="Offers Description" required="required"><?php echo $select1[desc]; ?></textarea>
								</div>
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Offers Image <span style="color:#ee4749">*</span></label>
