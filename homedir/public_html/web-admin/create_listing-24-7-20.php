...
$insert = mysqli_query($con,"insert into `listing`(`name`,`order`,`status`,`c_date`)values('$name','$order','$status','$c_date')") or die(mysqli_error($con));
...
$update = mysqli_query($con,"update `listing` set `name`='$name',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));

//$msg ='<center><span style="color:#ff0000;">Admin Updated Successfully<span></center>';
?>
<script type="text/javascript">
//alert('Delete Successfully');
window.location='listing_list.php?msg=updated';
</script>
<?php
}
					...
					<div class="panel-body">
					    ...
					    ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="name" placeholder="Tagline" required="required" value="<?php echo $select1['name']; ?>">
								</div>
							</div>
...
<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Location" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
					...
					<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Mobile" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>

							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Website <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Website" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Fax No" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Address" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
					...
					<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Facebook URL <span style="color:#ee4749">*</span></label>
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Facebook URL" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
							...
							<label for="field-1" class="col-sm-3 control-label">LinkedIn URL <span style="color:#ee4749">*</span></label>
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="LinkedIn URL" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Twitter URL" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
							...
							<label for="field-1" class="col-sm-3 control-label">Instagram URL <span style="color:#ee4749">*</span></label>
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Instagram URL" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
						...
						<label for="field-1" class="col-sm-3 control-label">Pinterest URL <span style="color:#ee4749">*</span></label>
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Pinterest URL" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
						...
						<label for="field-1" class="col-sm-3 control-label">Youtube URL <span style="color:#ee4749">*</span></label>
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Youtube URL" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
					...
					<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Video Link <span style="color:#ee4749">*</span></label>
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Video Link" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
					...
					<div class="form-group">
						       ...
						       <div class="col-sm-4">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Price From ($)" required="required" value="<?php echo $select1['order']; ?>">
								</div>

								<div class="col-sm-4">
									<input type="text" class="form-control" id="field-1" name="order" placeholder="Price To ($)" required="required" value="<?php echo $select1['order']; ?>">
								</div>
							</div>
