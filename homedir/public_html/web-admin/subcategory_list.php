...
{
$select  = mysqli_query($con,"delete from `sub_category` where `id`='".$_REQUEST['d_id']."' ")or die(mysqli_error($con));
?>
...
{
$msg ='<center><span style="color:#ff0000;">Sub Category Updated Successfully<span></center>';
}
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
		...
		<h2>Sub Category List <span style="float: right;"><a href="create_subcategory.php">Add Sub Category</a></span></h2>
		...
		<table class="table table-bordered datatable" id="table-4">
			...
			<tbody>
				...
				$select  = mysqli_query($con,"select * from `sub_category` where `id`!='' order by `id` desc ")or die(mysqli_error($con));
				$i='1';
				...
				<tr class="odd gradeX">
					...
					<td class="sorting_1">
						<a href="create_subcategory.php?e_id=<?php echo $select1['id']; ?>" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
						<?php //if($select1[type]=='1'){ ?>
						<a href="javascript:confirmDelete('subcategory_list.php?d_id=<?php echo $select1['id']; ?>')" class="btn btn-danger btn-sm btn-icon icon-left">
