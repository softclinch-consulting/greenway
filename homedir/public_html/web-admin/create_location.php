...
$qry_validate = mysqli_query($con,"select * from `location` where `name`='$name' ") or die(mysqli_error($con));
if(mysqli_num_rows($qry_validate)>0)
{
$msg ='<center><span style="color:#ff0000;">Location Already Exists<span></center>';
}
else
{

$insert = mysqli_query($con,"insert into `location`(`c_id`,`s_id`,`dt_id`,`name`,`keywords`,`meta_title`,`meta_key`,`meta_desc`,`desc`,`order`,`status`,`c_date`)values('$c_id','$s_id','$dt_id','$name','$keywords','$meta_title','$meta_key','$meta_desc','$desc','$order','$status','$c_date')") or die(mysqli_error($con));

$msg ='<center><span style="color:#ff0000;">Location Insert Successfully<span></center>';
}
...
$update = mysqli_query($con,"update `location` set `c_id`='$c_id',`s_id`='$s_id',`dt_id`='$dt_id',`name`='$name',`keywords`='$keywords',`meta_title`='$meta_title',`meta_key`='$meta_key',`meta_desc`='$meta_desc',`desc`='$desc',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));

//$msg ='<center><span style="color:#ff0000;">Admin Updated Successfully<span></center>';
?>
<script type="text/javascript">
//alert('Delete Successfully');
window.location='location_list.php?msg=updated';
</script>
<?php
}
...
{
$select  = mysqli_query($con,"select * from `location` where `id`='".$_REQUEST['e_id']."' ")or die(mysqli_error($con));
...
<?php include('top.php'); ?>
		...
		<h2>Create Location <span style="float: right;"><a href="location_list.php">Location List</a></span></h2>
		<br />
...
<?php } ?>
							...
							*/ ?>
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Location Name <span style="color:#ee4749">*</span></label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="name" placeholder="Location Name" required="required" value="<?php echo $select1['name']; ?>">
								</div>
							</div>
							...
							<!--<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea name="keywords" class="form-control" rows="4" placeholder="Keywords" ><?php echo $select1['keywords']; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea name="meta_key" class="form-control" rows="4" placeholder="Meta Keywords" ><?php echo $select1['meta_key']; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea name="meta_desc" class="form-control" rows="5" placeholder="Meta Description" ><?php echo $select1['meta_desc']; ?></textarea>
								</div>
							</div>
