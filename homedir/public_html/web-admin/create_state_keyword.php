...
$seo_link = addslashes($_REQUEST['seo_link']);
...
/*$qry_validate = mysqli_query($con,"select * from `state_keyword` where `name`='$name' ") or die(mysqli_error($con));
if(mysqli_num_rows($qry_validate)>0)
{
$msg ='<center><span style="color:#ff0000;">State Keyword already exists<span></center>';
}
else
{*/

$insert = mysqli_query($con,"insert into `state_keyword`(`s_id`,`name`,`keywords`,`meta_title`,`meta_key`,`meta_desc`,`desc`,`seo_link`,`order`,`status`,`c_date`)values('$s_id','$name','$keywords','$meta_title','$meta_key','$meta_desc','$desc','$seo_link','$order','$status','$c_date')") or die(mysqli_error($con));

$msg ='<center><span style="color:#ff0000;">State Keyword Insert Successfully<span></center>';
/*}*/
}
else
{
...
$update = mysqli_query($con,"update `state_keyword` set `s_id`='$s_id',`name`='$name',`keywords`='$keywords',`meta_title`='$meta_title',`meta_key`='$meta_key',`meta_desc`='$meta_desc',`desc`='$desc',`seo_link`='$seo_link',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));

//$msg ='<center><span style="color:#ff0000;">Admin Updated Successfully<span></center>';
?>
<script type="text/javascript">
//alert('Delete Successfully');
window.location='state_keyword_list.php?msg=updated';
</script>
<?php
}
...
{
$select  = mysqli_query($con,"select * from `state_keyword` where `id`='".$_REQUEST['e_id']."' ")or die(mysqli_error($con));
					...
					<ol class="breadcrumb bc-3" >
						...
						<a href="dashboard.php"><i class="fa-home"></i>Home</a>
							...
							<li>
									...
									<a href="#">State Keyword</a>
							</li>
						<li class="active">
		
									<strong>Create State Keyword</strong>
							</li>
							</ol>
					
		<h2>Create State Keyword<span style="float: right;"><a href="state_keyword_list.php">State Keyword List</a></span></h2>
		<br />
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
					    ...
					    ?>
							...
							<div class="form-group" >
								<label for="field-1" class="col-sm-3 control-label">SEO Canonical Link</label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" name="seo_link" placeholder="SEO Canonical Link" value="<?php echo $select1['seo_link']; ?>">
								</div>
							</div>
