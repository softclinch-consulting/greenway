...
$insert = mysqli_query($con,"insert into `state`(`c_id`,`name`,`keywords`,`meta_title`,`meta_key`,`meta_desc`,`desc`,`order`,`status`,`c_date`)values('$c_id','$name','$keywords','$meta_title','$meta_key','$meta_desc','$desc','$order','$status','$c_date')") or die(mysqli_error($con));
...
$update = mysqli_query($con,"update `state` set `c_id`='$c_id',`name`='$name',`keywords`='$keywords',`meta_title`='$meta_title',`meta_key`='$meta_key',`meta_desc`='$meta_desc',`desc`='$desc',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));
