	...
	<div class="main-content">
		...
		<table class="table table-bordered datatable" id="table-4">
			...
			<tbody>
				...
				$select  = mysqli_query($con,"select * from `banner` where `id`!='' order by `id` desc ")or die(mysqli_error($con));
				$i='1';
        ...
        ?>
				<tr class="odd gradeX">
					...
					<!--<td><?php if($select1['type']=='Home'){ echo "Home"; } else { echo $article1['name']; } ?></td>-->
