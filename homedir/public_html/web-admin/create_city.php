...
$insert = mysqli_query($con,"insert into `city`(`dt_id`,`name`,`order`,`status`,`c_date`)values('$dt_id','$name','$order','$status','$c_date')") or die(mysqli_error($con));
...
$update = mysqli_query($con,"update `city` set `c_id`='$c_id',`s_id`='$s_id',`dt_id`='$dt_id',`name`='$name',`order`='$order',`status`='$status' where `id`='".$_REQUEST['edit_id']."' ")or die(mysqli_error($con));
